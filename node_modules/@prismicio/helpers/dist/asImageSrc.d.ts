 ...
 */
export declare const asImageSrc: <Field extends import("@prismicio/types").EmptyImageFieldImage | import("@prismicio/types").FilledImageFieldImage | null | undefined>(field: Field, params?: ImgixURLParams) => AsImageSrcReturnType<Field>;
export {};
