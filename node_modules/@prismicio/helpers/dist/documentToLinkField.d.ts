 ...
 * @internal
 */
export declare const documentToLinkField: <TDocument extends SetOptional<PrismicDocument<Record<string, any>, string, string>, "slugs">>(prismicDocument: TDocument) => FilledLinkToDocumentField<TDocument["type"], TDocument["lang"], TDocument["data"]>;
export {};
