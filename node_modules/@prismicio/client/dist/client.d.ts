...
import { AbortSignalLike, FetchLike, HttpRequestLike, ExtractDocumentType } from "./types";
 ...
 */
export declare class Client<TDocuments extends prismicT.PrismicDocument = prismicT.PrismicDocument> {
    /**
